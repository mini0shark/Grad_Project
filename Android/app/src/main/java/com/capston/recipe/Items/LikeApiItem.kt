...
class LikeApiItem(
    ...
    @SerializedName("member_type")var memberType:Integer?=null,
    @SerializedName("profile_image")var profileImage:String?=null,
    @SerializedName("followers")var followers:ArrayList<FollowersApiItem>?=null
) {
    override fun toString(): String {
        return "LikeApiItem(id=$id, password=$password, lastLogin=$lastLogin, userId=$userId, name=$name, introduce=$introduce, joinDate=$joinDate, favoriteFood=$favoriteFood, nickname=$nickname, memberType=$memberType, profileImage=$profileImage, followers=$followers)"
    }
}
