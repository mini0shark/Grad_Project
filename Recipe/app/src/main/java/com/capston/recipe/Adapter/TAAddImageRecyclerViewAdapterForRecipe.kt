...
class TAAddImageRecyclerViewAdapterForRecipe(val context: Context, val fragment: Fragment, val addImageList:ArrayList<AddImageItem>):
    RecyclerView.Adapter<TAAddImageRecyclerViewAdapterForRecipe.ViewHolder>() {
    val TAG = "ImageRecycler Rec tag"
